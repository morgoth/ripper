...
=== Thor
  thor ripper:rip "Music/Destination directory"

You can see all options by:
  thor -T

When using thor you don't have to download Thorfile, simply just write:
  thor install http://github.com/morgoth/cd2mp3/raw/master/Thorfile --as ripper --force
